...
def test_split_data():
    ...
    assert len(X_train) + len(X_test) == total_samples, "Total samples mismatch after splitting"
    assert len(y_train) + len(y_test) == total_samples, "Total labels mismatch after splitting"
